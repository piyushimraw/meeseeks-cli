...
Write each analysis result to the corresponding .md file in `.kilocode/workflows/`:
- `.kilocode/workflows/ARCHITECTURE.md`
- `.kilocode/workflows/CONVENTION.md`
- `.kilocode/workflows/INTEGRATION.md`
- `.kilocode/workflows/STACK.md`
- `.kilocode/workflows/STRUCTURE.md`
